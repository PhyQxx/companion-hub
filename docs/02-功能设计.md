...
- [30-多主体持久化记忆设计.md](./30-多主体持久化记忆设计.md)：`user / assistant / shared`、`fact_key`、完整回合提取、一致性；
- [31-记忆时间线与历史回溯设计.md](./31-记忆时间线与历史回溯设计.md)：允许遗忘、Timeline、按时间/实体/语义回查、Source Expansion；
