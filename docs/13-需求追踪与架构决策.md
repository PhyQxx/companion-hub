...
|---|---|---|---|---|
| FR-I1 文字输入 | 02 §3.1/3.5；11 §7/11 | M1 | WS/REST E2E、30 轮稳定性 | designed |
...
| FR-I10 回合协调 | 09 §2~5 | M0 | 状态机 property test、kill/recover | designed |
...
| FR-C4 流式输出 | 02 §3.5；09 §2~4 | M1 | delta 顺序、取消、首包 P90 | designed |
| FR-C5 工具调用 | 10 §15；11 §5.3；12 §12 | M1 基线/M3B 扩展 | 注入/确认/unknown outcome | designed |
| FR-C6 多模型分级 | 02 §3.5；05 §5 | M1 | 路由、隐私、费用和降级 | designed |
| FR-M1 四层记忆 | 02 §3.6 | M1 | 类型/生命周期单测 | designed |
| FR-M2 混合检索 | 02 §3.6 | M1 | 正例/负例/类型配额 | designed |
| FR-M3 自动沉淀 | 02 §3.6；10 §2 | M1 | 新增/支持/冲突/替代 | designed |
| FR-M4 定时反思 | 02 §4.3；10 §2/5 | M3B | Job 幂等、弱推断不升级 | designed |
| FR-M5 遗忘删除 | 02 §3.6；10 §8；11 §6 | M1 | 跨存储删除和恢复 | designed |
| FR-M6 管理界面 | 05 §6 | M1 | CRUD/权限/冲突 | designed |
| FR-M7 溯源 | 02 memory_source；11 §4 | M1 | 多来源回链 | designed |
...
| 需求 | 设计 | 目标 | Verification | 状态 |
|---|---|---|---|---|
| FR-O1 文字输出 | 02 §3.8；09 §9 | M1 | 流式/补拉/重复/乱序 | designed |
...
| FR-S12 本地身份 | 09 §13；11 §5.2/12 | M0 | setup/pair/revoke/replay | designed |
...
v1.3 后产品范围冻结；技术设计在 M0.3 的 canonical Schema 和 14 文档 §10 契约测试通过后冻结：

- 允许：修复 P0/P1 安全、隐私、数据一致性和可实施性问题；
