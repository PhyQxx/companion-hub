...
export class LAppSubdelegate {
   ...
   * APPに必要な物を初期化する。
   */
  public initialize(canvas: HTMLCanvasElement, modelUrl: string): boolean {
    ...
    this._live2dManager.initialize(this, modelUrl);
  ...
  public isReady(): boolean {
    return this._live2dManager?.isReady() ?? false;
  }
